  ...
  return (
    <main id="profile" className="flex flex-wrap justify-center items-center md:justify-start sm:gap-10 gap-5">
      ...
      <div className="flex flex-col min-w-[250px] xs:min-w-[400px] gap-2 md:gap-4 max-w-xl flex-1 text-center sm:text-start">
        <Link
          href="https://www.linkedin.com/in/kasperi-jaakkola/"
          className="font-bold text-3xl md:text-4xl 2xl:text-5xl hover:scale-105 hover:underline hover:uppercase transition"
          rel="noopener noreferrer" target="_blank"
        > Kasperi Jaakkola
        </Link>
        <section className="text-sm md:text-base 2xl:text-lg flex-wrap">
      ...
      <section className="flex flex-col items-center lg:items-start gap-2 lg:ml-auto lg:w-auto w-full">
        ...
        <div className="border-2 border-foreground rounded-sm flex items-center p-2 2xl:p-4 gap-2 2xl:gap-4">
